...
class Plug extends Base {
	...
	public function plug_link_list(){
		...
		$plug_link=Db::name('Plug_link')->alias("a")->join(config('database.prefix').'plug_linktype b','a.plug_link_typeid =b.plug_linktype_id')->where($map)->order('plug_link_addtime desc')->paginate(10,false,['query'=>get_query()]);
